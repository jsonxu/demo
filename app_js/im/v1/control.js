...
(function($){
	...
	function im_showNonHistory(){
		...
		topTabCont.push('<li class="item clearfix on"><span class="bg1"></span><span class="bg2"></span><span class="s1"><img src="../../../temp/face1.png" /><i></i></span><span class="s2">韩都衣舍旗舰店</span><span class="s3">15</span><a href="javascript:;" class="close">关闭</a></li>');
		topTabCont.push('<li class="item clearfix"><span class="bg1"></span><span class="bg2"></span><span class="s1"><img src="../../../temp/face1.png" /><i></i></span><span class="s2">韩都衣舍旗舰店</span><span class="s3">15</span><a href="javascript:;" class="close">关闭</a></li>');
	...
	function im_showMerchantDSR(){
		...
		shopCont.push('<img src="../../../temp/face2.jpg" alt="商家昵称"/>');
	...
	function im_showProductInfo(){
		...
		proCont.push('<p class="pro_img"><a href=""><img src="../../../temp/pro.jpg" alt="产品名称"/></a></p>');
